...
def GA(init_size_population:int,number_loop:int,total_server:int,total_task:int,cut_points:int):
    files=open("./result/init_test_"+str(init_size_population)+"-task_"+str(total_task)+"-totalserver_"+str(total_server)+"-numberloop_"+str(number_loop)+"-points_"+str(cut_points)+".csv","w")
